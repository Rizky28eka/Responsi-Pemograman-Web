...
$sql = "SELECT id, nama, harga, spek, foto FROM androids"; // Replace with your actual table name and columns
    ...
    <main class="d-flex flex-nowrap">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px">
            <a href="#"
                ...
                <span class="fs-4">Mobile Shop</span>
            </a>
            <hr />
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="../androids/" class="nav-link active" aria-current="page">
                        <svg class="bi pe-none me-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <li>
                    <a href="../iphones/" class="nav-link link-body-emphasis">
                        <svg class="bi pe-none me-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
                            <path
                                d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z" />
                    ...
                    <?php
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        <th scope='row'>" . $no++ . "</th>
                                        <td><img src='" . $row["foto"] . "' alt='" . $row["nama"] . "' style='width: 100px; height: auto;'></td>
                                        <td>" . $row["nama"] . "</td>
                                        <td>" . $row["harga"] . "</td>
                                        <td>" . $row["spek"] . "</td>
                                        <td >
